/**
 * Example 06 - Removing all spaces in a MyString object.
 * Demonstrates how to remove all spaces.
 *
 * To compile:
 * gcc example/example06_removing_spaces.c -Iinclude -Lbuild -lmystring -o example/example06
 */
